...
- **问题四**：2026-09-11–17 预算 2.35 万元（2025 同期），预期点击 1.59 万（10%–90%：1.24–1.99 万）、注册 1102（855–1364）、CPC 1.48 元（1.18–1.90）；日历回归区间在滚动回测中的 80% 覆盖率为 78%–87%。
- **局限**：关键词只有年度汇总，响应曲线由单元弹性外推（校准 MAPE 约 33%）；注册归因为回归推断；2026 年的趋势无法从数据识别。
